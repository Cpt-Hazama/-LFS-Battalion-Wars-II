...
local lRocket1 = Vector(103.75,53.93,31.96)
local lRocket2 = Vector(103.78,75.39,25.8)
local rRocket1 = Vector(103.75,-53.93,31.96)
local rRocket2 = Vector(103.78,-75.39,25.8)

ENT.AIAttackRange = 50
ENT.GunnerStands = true
...
function ENT:RunOnSpawn()
	...
	self:SetGunnerSeat(self:AddPassengerSeat(Vector(10,-20,32.38),Angle(0,180,0)))
	self:AddPassengerSeat(Vector(10,20,32.38),Angle(0,0,0)).ExitPos = Vector(0,150,15)
end
...
function ENT:AltPrimaryAttack( Driver, Pod )
	...
	if !self:GetNWBool("RightTurret") then return end
		...
		self:EmitSound("LFS_WGUNSHIP_GUN")
	-- end
end
...
function ENT:PrimaryAttack()
	...
	self:EmitSound("LFS_WGUNSHIP_MISSILE")
