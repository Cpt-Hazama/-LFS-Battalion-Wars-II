...
local tGunner = Vector(-59.81,0.1,129.11)
local bomb = Vector(86,0,-40)
...
function ENT:AltPrimaryAttack( Driver, Pod, AllowPrimary )
	...
	local pos,ang = self:GetBonePosition(25)
	local bullet = {}
	bullet.Num 			= 1
	bullet.Src 			= pos +self:GetForward() *-25 +Vector(0,10,0)
...
function ENT:PrimaryAttack()
	...
	self:EmitSound("LFS_IBOMBER_BOMB")
	...
	ent.DMGDist = 400
	ent:SetModel("models/cpthazama/bwii/ironlegion/bomb.mdl")
...
function ENT:SecondaryAttack()
	...
	local pos,ang = self:GetBonePosition(22)
	local bullet = {}
	bullet.Num 			= 1
	bullet.Src 			= pos +self:GetForward() *15
	bullet.Dir 			= (TracePlane.HitPos -pos):GetNormalized()
	...
	local pos,ang = self:GetBonePosition(23)
	local bullet = {}
	bullet.Num 			= 1
	bullet.Src 			= pos +self:GetForward() *15
	bullet.Dir 			= (TracePlane.HitPos -pos):GetNormalized()
