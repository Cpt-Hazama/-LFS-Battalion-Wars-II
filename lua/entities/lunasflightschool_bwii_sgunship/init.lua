...
local lRocket1 = Vector(30.75,45,31.96)
local lRocket2 = Vector(30.78,45,25.8)
local rRocket1 = Vector(30.75,-45,31.96)
local rRocket2 = Vector(30.78,-45,25.8)
...
function ENT:SecondaryAttack( Driver, Pod )
	...
	local bullet = {}
	bullet.Num 			= 1
	bullet.Src 			= self:GetBonePosition(7) +self:GetRight() *35
	...
	self:EmitSound("LFS_SGUNSHIP_TURRET")
	self:TakeSecondaryAmmo()

	local bullet = {}
	bullet.Num 			= 1
	bullet.Src 			= self:GetBonePosition(8) +self:GetRight() *-35
	bullet.Dir 			= (TracePlane.HitPos - bullet.Src):GetNormalized()
	bullet.Spread 		= Vector(0.09,0.09,0)
	bullet.Tracer		= 1
	bullet.TracerName 	= "lfs_laser_blue"
...
function ENT:PrimaryAttack()
	...
	self:EmitSound("LFS_SGUNSHIP_MISSILE")
