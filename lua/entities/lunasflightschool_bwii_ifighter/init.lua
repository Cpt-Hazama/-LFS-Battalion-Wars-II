...
local lMissile = Vector(182.72,-0.94,44.26)
local rMissile = Vector(182.72,-0.94,44.26)
...
function ENT:RunOnSpawn()
	self:SetGunnerSeat(self:AddPassengerSeat(Vector(-15.18,-1.52,51.44),Angle(0,90,0)))
	self.FireCount = 0
end
...
function ENT:FireMissile(t)
	timer.Simple(t,function()
		if IsValid(self) then
			...
			self:EmitSound("LFS_IFIGHTER_MISSILE")
